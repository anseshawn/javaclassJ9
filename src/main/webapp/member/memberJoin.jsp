  ...
  <script src="${ctp}/js/woo.js"></script>
    ...
    function idCheck() {
   	 ...
   	 if(mid.trim() == "") {
   		 ...
   		 alert("아이디는 영문 대/소문자와 숫자, 밑줄을 포함하여 4~10자까지 가능합니다.");
...
<div class="col-xl-6 col-lg-8">
      ...
      <label for="email1">E-mail address: &nbsp;&nbsp;</label>
        <div class="form-check-inline">
	        <label class="form-check-label" style="font-size:13px">
	          <input type="checkbox" class="form-check-input" value="OK" name="emailNews" checked/>뉴스레터 구독하기
	        </label>
      	</div>
    ...
    <div id="company">
	    ...
	    <div class="form-group">
	      ...
	      <div class="input-group mb-1">
	        <input type="text" name="cPostcode" id="sample6_postcode2" placeholder="우편번호" class="form-control">
	        <div class="input-group-append">
	          <input type="button" onclick="sample6_execDaumPostcode2()" value="우편번호 찾기" class="btn btn-main-2 btn-round btn-icon-sm">
	        </div>
	      </div>
	      <input type="text" name="cRoadAddress" id="sample6_address2" size="50" placeholder="주소" class="form-control mb-1">
	      <div class="input-group mb-1">
	        <input type="text" name="cDetailAddress" id="sample6_detailAddress2" placeholder="상세주소" class="form-control"> &nbsp;&nbsp;
	        <div class="input-group-append">
	          <input type="text" name="cExtraAddress" id="sample6_extraAddress2" placeholder="참고항목" class="form-control">
	        </div>
	      </div>
	    </div>
	    <div class="form-group">
