      ...
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <ul class="list-inline breadcumb-nav" style="font-size: 16px;">
            <li class="list-inline-item"><a href="Service.do" class="text-white-50">온라인 상담</a></li>
            <li class="list-inline-item"><span class="text-white">/</span></li>
            <li class="list-inline-item"><a href="Complaint.do" class="text-white">불편사항 신고</a></li>
          </ul>
        </div>
      </div>
    </div>
